...
export default function Header() {
  return (
    <header className="text-center container pt-16 ">
      ...
      <div className="flex items-center max-w-[280px]  mx-auto mt-8 gap-[8px] shadow-md p-[5px_16px] rounded-[8px] border-2 border-[] bg-[#FFF]">
